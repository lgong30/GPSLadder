...
class TeXBuilder(object):
    ...
    def __init__(self, template_dir=None, templates=None, default="default"):
        if template_dir is None:
            self.template_dir = os.path.join(THIS_DIR, "template")
        else:
            self.template_dir = template_dir
        if templates is None:
            self.templates = {"default": "gps_ladder_template.tex"}
        else:
